        ...
        <Layout>
            <Container maxW='container.md'>
                ...
                <Box display={{ md: 'flex' }}>
                    <Box flexGrow={1}>
                        ...
                        <p style={{ display: "flex", flexWrap: "warp" }}>I'm...
                            <Typewriter
                                options={{
                                    strings: ['a Tech Enthusiast', 'a World Traveller', 'an aspiring Product Manager', 'a Student-Athlete', 'a Humanitarian'],
                                    autoStart: true,
                                    delay: 75,
                                    deleteSpeed: 80,
                                    loop: true,
                ...
                <Section delay={0.3}>
                    ...
                    <Paragraph>
                        In my free time, I like to play basketball and go to the gym. I have also been an active member of {' '}

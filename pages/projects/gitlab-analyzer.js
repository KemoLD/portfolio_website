    ...
    <Layout title="GitLab Analyzer">
        <Container maxW='container.md'>
            ...
            <P>
                ...
                based on the file type. File types are given weights, which are multiplied by the underlined contribitions. There is also a feaure that allows certain file types 
                to be excluded from the score calculation. The data is then sorted into graphs and charts. Scores are given to each user and can be by sorted by commits or a date-range. 

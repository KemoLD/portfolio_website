    ...
    <Layout title="Restaurant Website">
        <Container maxW='container.md'>
            ...
            <P>
                ...
                "featured" labels; if they are not active they will not be displayed, and if they are featured, they will be 
                 displayed on the front page. The website also tracks the revenue generated by orders with a "delivered" status, 
                 which I think is a really cool feature. All data is stored in a MySQL database and the admin panel is secured 
                 by access control and all passwords are encrypted.

            </P>
            <List ml={4} my={4}>
                <ListItem>
                    <Meta>Website</Meta>
                    <Link href="https://kemos-restaurant.herokuapp.com" target="_blank" rel='noopener noreferrer'>
                        https://kemos-restaurant.herokuapp.com/ <ExternalLinkIcon mx="2px" />
                    </Link>
                </ListItem>
                <ListItem>
                    <Meta>Source Code</Meta>
                    <Link href="https://github.com/KemoLD/restaurant_website" target="_blank" rel='noopener noreferrer'>
